...
/**
 * Title: archive-album
 * Slug: swiftsearch/archive-album
 * Categories: hidden
 * Inserter: no
 */
?>
...
<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--medium)"><!-- wp:group {"align":"full","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
<div class="wp-block-group alignfull"><!-- wp:query-title {"type":"archive","showPrefix":false,"style":{"spacing":{"margin":{"bottom":"0"}}},"fontSize":"large"} /-->

<!-- wp:navigation {"ref":516,"overlayMenu":"never","layout":{"type":"flex","justifyContent":"left"},"style":{"typography":{"textDecoration":"underline"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
